...
lora_init(void)
{
   ...
   io_conf.pin_bit_mask = GPIO_OUTPUT_PINMASK;//((1ULL<<CONFIG_RST_GPIO)|(1ULL<<CONFIG_CS_GPIO))
   ...
   io_conf.pin_bit_mask = GPIO_INPUT_PINMASK;//(1ULL<<CONFIG_DIO0_GPIO)
   //set as input mode
   ...
   gpio_isr_handler_add(CONFIG_DIO0_GPIO, gpio_isr_handler, (void*) CONFIG_DIO0_GPIO);
